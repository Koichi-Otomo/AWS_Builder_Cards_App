...
namespace AWSBuilderCards
{
    public class UIManager : MonoBehaviour
    {
        ...
        GameObject CreateCardButton(Card card, int index, Player player)
        {
            ...
            var txt = txtGO.AddComponent<Text>(); txt.alignment = TextAnchor.MiddleCenter; txt.color = Color.black; txt.font = Resources.GetBuiltinResource<Font>("Arial.ttf"); 
            txt.text = card.Name + " (" + card.Cost + " Cost)";
